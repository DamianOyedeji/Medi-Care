        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="p-8 rounded-3xl bg-stone-50 hover:bg-white hover:shadow-xl hover:shadow-stone-200/40 transition-all duration-300 border border-transparent hover:border-stone-100 group"
            >
