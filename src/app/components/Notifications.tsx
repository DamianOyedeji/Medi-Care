...
export function Notifications({ onBack }: NotificationsProps) {
    ...
    return (
        <div className="min-h-screen bg-stone-50 text-stone-900 font-sans">
            {/* Header */}
            <header className="bg-white/80 backdrop-blur-md border-b border-stone-100 sticky top-0 z-10 px-4 sm:px-6 h-16 flex items-center justify-between">
                <button
                    onClick={onBack}
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 space-y-8">
                {notifications.length === 0 ? (
                    ...
                    >
                        ...
                        <h2 className="text-stone-600 font-semibold text-lg">No notifications yet</h2>
                    ...
                    groups.map(([label, items], gi) => (
                        ...
                        >
                            <p className="text-xs font-bold text-stone-400 uppercase tracking-wider mb-3 px-1">{label}</p>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="font-semibold text-stone-800 text-sm leading-tight">{n.title}</p>
                                                <p className="text-stone-500 text-sm mt-0.5 leading-snug">{n.body}</p>
