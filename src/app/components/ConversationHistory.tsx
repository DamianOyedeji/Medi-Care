      ...
      <div className="max-w-2xl mx-auto">
        <header className="mb-10">
          ...
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-stone-800 mb-2 font-serif tracking-tight">Your Conversations</h1>
            <div className="flex items-center justify-center gap-2 text-stone-500 text-sm bg-white/50 inline-block px-4 py-1.5 rounded-full backdrop-blur-sm border border-stone-100">
              <Lock size={12} />
            ...
            <AnimatePresence mode="popLayout">
              {sessions.map((session, index) => (
                <motion.div
                  ...
                  className="group relative bg-white hover:bg-stone-50/50 p-6 rounded-2xl shadow-sm hover:shadow-md border border-stone-100 transition-all cursor-pointer overflow-hidden"
                >
                  ...
                  <div className="flex justify-between items-start gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-stone-700 font-medium leading-relaxed font-serif text-lg">
                        &quot;{session.preview}&quot;
                      </p>
                    </div>
